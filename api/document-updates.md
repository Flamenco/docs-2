...
You can also use a transaction to detect the origin in the update handler.  In this example, it will prevent doc2 from sending a redundant update back to doc1.
